...
--
-- Table structure for table `teams_challenges`
--

CREATE TABLE `teams_challenges` (
  `id` int(11) NOT NULL,
  `team_id` int(11) NOT NULL,
  `opponent_id` int(11) NOT NULL,
...
--
-- Table structure for table `teams_msg`
--

CREATE TABLE `teams_msg` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `teams_msg`
--

INSERT INTO `teams_msg` (`id`, `challenges_id`, `team_id`, `opponent_id`, `msg`, `date`, `notification`, `seen`) VALUES
...
--
-- Table structure for table `teams_sports`
--

CREATE TABLE `teams_sports` (
  `id` int(11) NOT NULL,
  `team_id` int(11) NOT NULL,
  `sport_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1
...
--
-- Dumping data for table `teams_sports`
--

INSERT INTO `teams_sports` (`id`, `team_id`, `sport_id`, `status`) VALUES
(3, 2, 8, 1),
(4, 2, 5, 1),
(7, 1, 8, 1),
(8, 1, 5, 1);
...
--
-- Indexes for table `teams_challenges`
--
ALTER TABLE `teams_challenges`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `teams_msg`
--
ALTER TABLE `teams_msg`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `teams_sports`
--
